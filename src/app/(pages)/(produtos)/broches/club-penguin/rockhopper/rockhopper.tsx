...
const data = [
    { id: '1', image: '/assets/pins-frente/2.jpg' },
    { id: '2', image: '/assets/pins-verso/pirataatras.jpg' },
    { id: '3', image: '/assets/pins/2.jpg' }
]
...
export default function PinOne() {
    return (
        <DivUmBroche >
            <DivDoisBroche>
                <DivTresBroche>
                    <DivQuatroBroche>
                        ...
                        <DivSeisBroche>
                            ...
                            {/* <ParagrafoDoisBroche>
                                <strong>
                                    Frete fixo: R$ 15,00 – Por tempo limitado!
                                </strong>
                            </ParagrafoDoisBroche> */}
                            <DivOitoBroche>
                                <DescricaoProduto />
