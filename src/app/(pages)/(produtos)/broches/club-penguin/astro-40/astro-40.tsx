...
import DescricaoProdutoSelo from "@/app/components/common/produtos/descricao-produto-selo";

register()

const data = [
    { id: '1', image: '/assets/pins-frente/10.jpg' },
    { id: '2', image: '/assets/pins-verso/hexagono.jpg' },
    { id: '3', image: '/assets/pins/10.jpg' }
]
...
export default function PinTen() {
    return (
        <DivUmBroche >
            <DivDoisBroche>
                <DivTresBroche>
